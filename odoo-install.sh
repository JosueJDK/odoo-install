...
sudo su - postgres -c "createuser -s root" || psql template1 || alter role root with password 'root';
...
sudo apt install wget git bzr python3-pip gdebi-core -y

echo -e "\n---- Instalar python packages ----"
sudo apt install python3-pypdf2 python3-babel python3-passlib python3-werkzeug==0.11.15 python3-decorator python3-dateutil python3-psycopg2 python3-psutil python3-html2text python3-docutils python3-lxml python3-reportlab python3-requests python3-xlsxwriter python3-vobject python3-openid python3-pyparsing python3-pydot python3-mock python3-mako python3-jinja2 python3-feedparser python3-xlwt python3-psycogreen python3-greenlet python3-xlrd python3-num2words python3-polib
...
sudo apt install node-clean-css node-less python3-gevent python3-libsass -y
